...
options = {
  ...
  map_frame = "robot_0/map",  -- map frame name 
  tracking_frame = "robot_0/laser",  -- tracking frame name
  published_frame = "robot_0/base_link",  -- published frame name 
  odom_frame = "robot_0/odom",  -- name of the odometer frame
